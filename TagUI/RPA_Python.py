...
# 在 Yahoo 上搜索的示例脚本，截取结果并访问 DuckDuckgo
...
# use click() to click on a UI element or x, y location
...
r.snap('page', './images/results.png')
r.snap('logo', './images/logo.png')
...
r.wait()
r.snap('page', './images/duckduckgo.png')
r.wait(4.4)
